...
//Step 1:
-Go to the App Directory and run this Command in the Terminal: npm start
---------------------------------------------------------------------------------------------------------------------------------

//Step 2: 
-In the Project You will see the Server Folder
-Open one more Terminal and go to the Server Directory and run this command: npm start
-This will help to store the Data in the Local Machine
---------------------------------------------------------------------------------------------------------------------------------
